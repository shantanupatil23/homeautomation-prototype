...
public class MyForeGroundServicePhoneOFF extends Service {
    ...
    public MyForeGroundServicePhoneOFF(){
        final CountDownTimer wait_state = new CountDownTimer(3600000, 1000) {
            ...
            public void onFinish() {
                final CountDownTimer timer = new CountDownTimer(time_delay_read*1000, 1000) {
                    ...
                    public void onFinish() {
                        final DatabaseReference phone_auto_firebase = FirebaseDatabase.getInstance().getReference().child("NodeMCU").child("switch_status_phone");
...
//            time_delay_read = intent.getStringExtra("time_delay_read");
    ...
    private void startForegroundService() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_1_ID)
                .setContentTitle("Phone's charging will turn OFF at " + output_time_of_execution_hour + ":" + output_time_of_execution_min)
