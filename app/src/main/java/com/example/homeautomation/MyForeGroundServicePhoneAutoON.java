...
public class MyForeGroundServicePhoneAutoON extends Service {
    ...
    public MyForeGroundServicePhoneAutoON(){
            ...
            public void onFinish() {
                final CountDownTimer timer = new CountDownTimer(time_delay_read*1000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Intent intent = new Intent(MyForeGroundServicePhoneAutoON.this, MyForeGroundServicePhoneAuto.class);
...
//            time_delay_read = intent.getStringExtra("time_delay_read");
    ...
    private void startForegroundService() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_1_ID)
                .setContentTitle("Phone's automatic charging will turn ON at " + output_time_of_execution_hour + ":" + output_time_of_execution_min)
