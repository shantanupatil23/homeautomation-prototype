    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            case R.id.config_sockets:
                ...
                popupWindow_sockets = new PopupWindow(popupView_sockets, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, false);
            ...
            case R.id.change_auto_details:
                ...
                popupWindow_auto = new PopupWindow(popupView_auto, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, false);
