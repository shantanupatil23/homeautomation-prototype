...
public class MyForeGroundServiceLaptopON extends Service {
    ...
    public MyForeGroundServiceLaptopON(){
...
//            time_delay_read = intent.getStringExtra("time_delay_read");
    ...
    private void startForegroundService() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_1_ID)
                .setContentTitle("Laptop's charging will turn ON at " + output_time_of_execution_hour + ":" + output_time_of_execution_min)
